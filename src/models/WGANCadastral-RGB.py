...
file_handler = logging.FileHandler('../../reports/WGAN_CadastralRGB_Optimisation.log')
...
func = lambda trial: objective(trial, nz, dataloader, n_epochs = num_epochs, folder = '../../', experiment='WGANRGB', AlternativeTraining = AltTrain, logger = logger)
