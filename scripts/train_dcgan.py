...
GP_RATE = 1e+1  # gradient penalty rate
COND_RATE = 5e+0  # conditional regularization (based on percentage of Roads - Greens - Buildings)
MAX_FRAC = 0.7  # threshold of maximum fraction of particular condition
